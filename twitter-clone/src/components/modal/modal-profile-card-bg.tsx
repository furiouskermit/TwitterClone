...
import { ProfileImgItem, ProfileImgItemImg, ProfileImgItemInput, ProfileImgItemLabel, ProfileImgList } from "../../css/profile-components";
            ...
            <ProfileImgList>
                {
                    Array.from({length: 6}, (_, index)=>
                        <ProfileImgItem key={`cardBgItem${index}`}>
                            <ProfileImgItemInput type="radio" name="cardBgImg" id={`cardBgImg${index}`} onChange={changeImg} value={`cardBgImg${index}`} defaultChecked={props.curentImg === `/profile/jobs/cardBgImg${index}.png` ? true : false} />
